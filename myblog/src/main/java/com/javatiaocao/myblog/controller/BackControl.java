...
import com.tiaozaowang.utils.TransCodingUtil;
...
public class BackControl {
    ...
    public String show(@PathVariable("articleId") long articleId,
        ...
        Map<String, String> articleMap = articleService.findArticleByArticleId(articleId);
        if (articleMap.get("articleTitle") != null) {
            ...
            if (articleTabloid.length() <= 110) {
                model.addAttribute("articleTabloid", articleTabloid);  //为什么过长的原因
            } else {
